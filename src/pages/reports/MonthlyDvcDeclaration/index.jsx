        ...
        <table className="mb-8 mt-8 table-fixed border-collapse border border-black" width="100%">
          <thead>
            ...
            <tr className="bg-bright-yellow text-black">
              <th className="border border-black" width="10%">Day</th>
              <th className="border border-black" width="12%">DCV (MMscf)</th>
              <th className="border border-black" width="78%">Comments</th>
            </tr>
          </thead>
          <tbody>
            {data.map((log, index) => (
